...
OrderBookRouter.put('/update-order', (0, auth_1.default)(user_const_1.userRole.admin), orderBooks_controller_1.orderBookController.updateBookOrder);
...
OrderBookRouter.get('/', (0, auth_1.default)(user_const_1.userRole.admin), orderBooks_controller_1.orderBookController.getAllOrders);
...
OrderBookRouter.delete('/:orderId', (0, auth_1.default)(user_const_1.userRole.user, user_const_1.userRole.admin), orderBooks_controller_1.orderBookController.deleteBookOrder);
OrderBookRouter.delete('/:orderId', (0, auth_1.default)(user_const_1.userRole.admin, user_const_1.userRole.admin), orderBooks_controller_1.orderBookController.adminDeleteBookOrder);
